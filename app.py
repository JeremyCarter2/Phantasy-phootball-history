...
if page == "Overview":
    ...
    st.write(
        "This is the front door to the league archive. Ask about owners, players, "
        "trades, drafts, records, rivalries, luck, or lineup decisions."
    )
    st.caption(
